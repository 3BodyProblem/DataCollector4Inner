...
public:
	 ...
	 * @return			==0					写成功
						<0					失败
	 */
    int					Record( unsigned short usMessageNo, unsigned short usFunctionID, const char* pszData, unsigned int nLen );
...
public:
	 ...
	 * @return			>0					写成功
						...
						<0					失败
	 */
    int					Read( unsigned short& usMessageNo, unsigned short& usFunctionID, char* pszData, unsigned int nLen );
